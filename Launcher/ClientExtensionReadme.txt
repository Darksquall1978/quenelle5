...
You can also use /connectsrv <server display name> to connect to a server by
its name in the online server list supplied by the master server tracker.
...
/connectsrv <"server name"> <category> [DM-pw] - Connects to a server, possibly
                                                 disconnecting from the current
                                                 server.  The supplied DM
                                                 password must not contain
                                                 spaces.  The server name is
                                                 looked up from the online
                                                 server list as a
                                                 case-insensitive exact match.
                                                 The server name must be quoted
                                                 if it contains spaces.  The
                                                 category designates the game
                                                 type of the server.  It can be
...
/mspells <Button Number>                       - Create a custom macro command
                                                 to memorize all your currently
                                                 memorized spells when you use
                                                 the designated button.  NOTE:
                                                 this will clear your spell
                                                 usages when used if any spells
                                                 were replaced.
...
/effectfade                                    - Toggles floating text
                                                 announcements when effect
                                                 icons (i.e., for buff spells)
                                                 fade on your character.

/selectitem [item name]                        - Selects an item by name.  This
                                                 command is useful for hotbar
                                                 macros that cast spells, such
                                                 as Magic Weapon.
...
press a hotbar button.  The tooltip for a macro hotbar button lists all of the
commands that are run when you activate that button.
...
You can create a macro hotbar button to memorize all your currently memorized
spells.  This is useful in scenarios where your character might polymorph or
otherwise equip and un-equip items that alter their spellcasting stats.  The
/mspells <hotbutton number> command will create such a macro.
